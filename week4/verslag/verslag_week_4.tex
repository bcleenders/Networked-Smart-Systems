...
\section{Geluidssynchronisatie}\label{sec:geluidssec}
...
Tijdens de tests hebben we gemerkt dat synchronisatie minder snel verloopt als twee (groepen) nodes via \'e\'en tussennode verbonden zijn. De twee groepen synchroniseerden wel, maar minder snel dan wanneer alle nodes binnen ontvangsbereik zijn.

Een nadeel aan het gebruik van de radiosynchronisatie, is dat gedurende de helft van de tijd de radio luistert naar signalen. Dit kost relatief veel stroom, maar als de radio minder dan de helft van de tijd luistert kan niet gegarandeerd worden dat het netwerk in alle gevallen synchroniseert.
